 ...
 * Como el uso de herramientas implica una **conversación continua**, cambio el envio de mensajes para que en
...
Cuarta jornada:
 * Configuro **Prompt caching** para ahorrar tokens 
   * En la jornada he duplicado el costo, pero he multiplicado por más de 4 los 
tokens de entrada y por menos de 3 los de salida. 
 * Creo un servicio para en base al texto del prompt **decidir que tools enviar**
como disponibles a claude, ahorrando asi tokens.
 ...
 * Cuarta jornada, caching y tool selector 
   * 0,27 USD, 10h
   * Total de tokens de entrada 183.160
   * Total de tokens de salida 27.170
   * Tasa de caché 45,8%